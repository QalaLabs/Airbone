...
const MOCK_AUDIT_TRAIL = [
  { id: "aud-201", actionType: "FEE_TRANCHE_UPDATE", user: "Capt. Vikram Singh", email: "vikram.singh@airborneaviation.academy", timestamp: "2026-06-26 10:42:15", ipAddress: "103.82.91.42 (Delhi, IN)", description: "Updated Course Tuition Fee for CPL Ground School to ₹4,50,000", integrityHash: "sha256:8f9a3e2b1c4d7e8f9a0b1c2d3e4f5a6b", module: "Courses" },
  { id: "aud-202", actionType: "STAGE_PROMOTED", user: "Anjali Sharma", email: "anjali.sharma@airborneaviation.academy", timestamp: "2026-06-26 10:35:10", ipAddress: "122.161.45.12 (Noida, IN)", description: "Moved candidate Rajesh Kumar (LD-9204) to Fee Payment stage", integrityHash: "sha256:1a2b3c4d5e6f7a8b9c0d1e2f3a4b5c6d", module: "Admissions" },
  { id: "aud-203", actionType: "WHATSAPP_DISPATCH", user: "Anjali Sharma", email: "anjali.sharma@airborneaviation.academy", timestamp: "2026-06-26 10:31:05", ipAddress: "122.161.45.12 (Noida, IN)", description: "Triggered Fee Payment Link template to +91 9876543210", integrityHash: "sha256:5e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0b", module: "Notifications" },
  { id: "aud-204", actionType: "VAPI_ESCALATION", user: "Rohan Verma", email: "rohan.verma@airborneaviation.academy", timestamp: "2026-06-26 09:55:22", ipAddress: "115.112.14.88 (Gurgaon, IN)", description: "Claimed Vapi Voice AI escalation for candidate Amit Sen", integrityHash: "sha256:9c0d1e2f3a4b5c6d7e8f9a0b1c2d3e4f", module: "Vapi AI" },
  { id: "aud-205", actionType: "PAGE_PUBLISHED", user: "Priya Patel", email: "priya.patel@airborneaviation.academy", timestamp: "2026-06-26 09:12:44", ipAddress: "103.21.124.9 (Mumbai, IN)", description: "Published Winter Intake Landing Page draft in CMS", integrityHash: "sha256:3a4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d", module: "CMS" },
  { id: "aud-206", actionType: "MEDIA_UPLOADED", user: "Siddharth Sen", email: "siddharth.sen@airborneaviation.academy", timestamp: "2026-06-25 18:44:30", ipAddress: "182.65.112.4 (Delhi, IN)", description: "Uploaded 12 high-res fleet photos to S3 CDN bucket", integrityHash: "sha256:7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b", module: "Media Library" },
  { id: "aud-207", actionType: "DRIVE_SCHEDULED", user: "Vikram Malhotra", email: "v.malhotra@airborneaviation.academy", timestamp: "2026-06-25 14:20:11", ipAddress: "103.82.91.42 (Delhi, IN)", description: "Scheduled Indigo A320 Cadet Pilot Screening Drive", integrityHash: "sha256:4f5a6b7c8d9e0f1a2b3c4d5e6f7a8b9c", module: "Placements" },
  { id: "aud-208", actionType: "SYSTEM_RESTART", user: "Capt. Vikram Singh", email: "vikram.singh@airborneaviation.academy", timestamp: "2026-06-25 08:00:00", ipAddress: "103.82.91.42 (Delhi, IN)", description: "Applied rolling zero-downtime container environment synchronization", integrityHash: "sha256:0f1a2b3c4d5e6f7a8b9c0d1e2f3a4b5c", module: "System Config" },
];
