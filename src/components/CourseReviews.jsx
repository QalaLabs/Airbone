/**
 * Shared course page reviews (1–3) + parent testimonials (W3 / W4).
 */
...
export default function CourseReviews({
  ...
  return (
    <section style={{ marginTop: '3.5rem', marginBottom: '2rem' }} aria-labelledby="course-reviews-heading">
      ...
      <ReviewGrid list={list} />
      {showParents && (
        <div style={{ marginTop: '2rem' }}>
          <h3 style={{ fontFamily: 'var(--font-h)', fontSize: '1.05rem', fontWeight: 800, color: 'var(--navy)', marginBottom: '1rem' }}>
            Parents on Airborne &amp; Capt. Navrang
          </h3>
          <ReviewGrid list={PARENT_TESTIMONIALS} />
        </div>
      )}
    </section>
  )
