...
export default function KineticTeamHybrid({ items = TEAM }: { items?: TeamMember[] }) {
          ...
          <AnimatePresence mode="wait">
            {activeId && (
              ...
              >
                ...
                <Image
                  src={items.find((t) => t.id === activeId)?.image || ''}
                  alt="Preview"
                  fill
                ...
                {/* Overlay Metadata */}
                <div className="absolute bottom-0 w-full bg-gradient-to-t bg-linear-to-t from-black/80 to-transparent p-4">
            ...
            <div className="p-4">
              <div className="relative aspect-video w-full overflow-hidden rounded-lg">
                <Image 
                  ...
                  fill
                />
                <div className="absolute inset-0 bg-gradient-to-t bg-linear-to-t from-black/60 to-transparent" />
