...
/**
 * AIRBORNE AVIATION ACADEMY — V6 App (Homepage Client-Side Component)
  ...
  return (
    <nav className={`nav ${scrolled ? 'scrolled' : ''}`}>
      <a href="#top" className="nav-logo" aria-label="Airborne Aviation Academy home">
        ...
        <div>
          <div className="nav-logo-name">Air<span className="o">b</span>orne</div>
...
function Modal({ open, type, onClose }) {
  ...
  return (
    <div
      className={`modal-bg modal-bg-dark ${open ? 'open' : ''}`}
