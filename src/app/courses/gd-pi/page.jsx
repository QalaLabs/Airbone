...
const coursePageGraph = buildCoursePageGraph({
  ...
  },
  {
    ...
    a: 'GD & PI Course (₹30,000) is the foundational track for group discussion and interview skills. Airline Interview Preparation (₹1,00,000) is the premium 3-month package with deeper mock airline panels and extended coaching.'
  },
  {
    ...
    <>
      ...
      <main className="course-main-wrapper" style={{ padding: '6rem var(--margin) 6rem var(--margin)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem', minWidth: 0, width: '100%' }}>
            ...
            <div>
              ...
              <p className="ov-body" style={{ marginTop: '1.5rem', color: 'rgba(0, 39, 76, 0.75)', fontSize: '1.05rem', lineHeight: '1.75' }}>
                ...
                <Link href="/courses/airline-preparation" style={{ color: 'var(--red)', fontWeight: 600 }}>Airline Interview Preparation (₹1,00,000)</Link>.
              </p>
            </div>
            ...
            <div className="course-section-divider">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
                {[
                  ...
                  { q: 'How is this different from Airline Interview Preparation?', a: 'This ₹30,000 course is the foundational GD/PI track. Airline Interview Preparation (₹1,00,000) is the premium package with deeper mock airline panels.' },
        ...
        <CoursePageFooter
          ...
          nextCourses={[
            { label: 'Airline Interview Preparation', href: '/courses/airline-preparation', note: 'Premium 3-month airline selection track (₹1,00,000)' },
