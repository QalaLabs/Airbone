    ...
    <>
      ...
      <main style={{ minHeight: '80vh', background: '#000810', padding: '4rem var(--margin) 6rem var(--margin)' }}>
        ...
        <div style={{ display: 'flex', gap: '0.5rem', fontSize: '0.75rem', color: 'rgba(255,255,255,0.4)', marginBottom: '3rem', fontFamily: 'var(--font-h)', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase' }}>
          ...
          <span>/</span>
          <span style={{ color: '#D8A027' }}>Cabin Crew Training</span>
        </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
            ...
            <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: '2.5rem' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem' }}>
                <div style={{ background: '#00162e', border: '1px solid rgba(255,255,255,0.06)', padding: '2rem', borderRadius: '4px' }}>
                  <div style={{ fontFamily: 'var(--font-h)', fontSize: '1rem', fontWeight: 800, color: '#FFFFFF', marginBottom: '0.25rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Capt. Mukul Mitra Barua</div>
                  <div style={{ fontSize: '0.75rem', color: '#D8A027', fontFamily: 'var(--font-h)', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: '1rem' }}>Lead Trainer — Aviation Training & Safety</div>
                  <p style={{ fontSize: '0.82rem', color: 'rgba(255,255,255,0.65)', lineHeight: '1.7', margin: '0 0 1rem 0' }}>
                  ...
                  <p style={{ fontSize: '0.8rem', color: 'rgba(255,255,255,0.4)', fontStyle: 'italic', margin: 0, borderLeft: '2px solid rgba(216,160,39,0.3)', paddingLeft: '0.75rem' }}>
                    "Cabin crew is not about looking the part. It is about being the calmest person on board when something goes wrong."
                  </p>
                </div>
                <div style={{ background: '#00162e', border: '1px solid rgba(255,255,255,0.06)', padding: '2rem', borderRadius: '4px' }}>
                  <div style={{ fontFamily: 'var(--font-h)', fontSize: '1rem', fontWeight: 800, color: '#FFFFFF', marginBottom: '0.25rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Rajeet Khalsa</div>
                  <div style={{ fontSize: '0.75rem', color: '#D8A027', fontFamily: 'var(--font-h)', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: '1rem' }}>Lead Trainer — Soft Skills & Professional Readiness</div>
                  <p style={{ fontSize: '0.82rem', color: 'rgba(255,255,255,0.65)', lineHeight: '1.7', margin: '0 0 1rem 0' }}>
            ...
            <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: '2.5rem' }}>
              <div style={{ background: 'rgba(219,36,30,0.06)', border: '1px solid rgba(219,36,30,0.3)', borderRadius: '6px', padding: '1.5rem 2rem' }}>
                ...
                <div style={{ fontFamily: 'var(--font-h)', fontSize: '1.2rem', fontWeight: 800, color: '#FFFFFF', marginBottom: '0.75rem' }}>Batch 1 Scholarship — First 20 Students</div>
                <p style={{ fontSize: '0.85rem', color: 'rgba(255,255,255,0.7)', lineHeight: '1.6', margin: '0 0 1rem 0' }}>
                  All Batch 1 students take a free eligibility test. Based on result, they are placed at P1, P2, or P3 level. <strong style={{ color: '#D8A027' }}>P1 (worth ₹54,000) is FREE for all Batch 1 students.</strong>
                </p>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '0.75rem' }}>
                  {[
                    ...
                    <div key={i} style={{ background: 'rgba(0,0,0,0.3)', border: '1px solid rgba(216,160,39,0.15)', borderRadius: '4px', padding: '1rem', textAlign: 'center' }}>
                      <div style={{ fontSize: '0.75rem', color: 'rgba(255,255,255,0.5)', marginBottom: '0.4rem' }}>{row.level}</div>
                      <div style={{ fontFamily: 'var(--font-h)', fontSize: '1.4rem', fontWeight: 900, color: '#D8A027' }}>{row.fee}</div>
                      <div style={{ fontSize: '0.68rem', color: 'rgba(255,255,255,0.3)', marginTop: '0.25rem' }}>{row.note}</div>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: '2.5rem' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                {PATHWAYS.map((p, i) => (
                  <div key={i} style={{ background: '#00162e', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '4px', padding: '2rem' }}>
                    <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem', marginBottom: '1.25rem' }}>
                      <div style={{ flexShrink: 0, width: '2.5rem', height: '2.5rem', borderRadius: '50%', background: '#DB241E', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'var(--font-h)', fontSize: '1rem', fontWeight: 900, color: '#fff' }}>P{p.num}</div>
                      <div>
                        <div style={{ fontFamily: 'var(--font-h)', fontSize: '1rem', fontWeight: 800, color: '#FFFFFF', textTransform: 'uppercase', letterSpacing: '0.04em' }}>{p.title}</div>
                        <div style={{ fontSize: '0.78rem', color: 'rgba(255,255,255,0.4)', marginTop: '0.2rem' }}>{p.duration} · {p.classTime} daily · Best for: {p.best}</div>
                      </div>
                    </div>
                    <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap', marginBottom: '1.25rem' }}>
                      <div>
                        <div style={{ fontSize: '0.65rem', color: 'rgba(255,255,255,0.4)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '0.2rem' }}>Regular Price</div>
                        <div style={{ fontFamily: 'var(--font-h)', fontSize: '1.25rem', fontWeight: 800, color: '#D8A027' }}>{p.regular}</div>
                      </div>
                      <div>
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
                      {p.focus.map((f, j) => (
                        <span key={j} style={{ fontSize: '0.72rem', color: 'rgba(255,255,255,0.6)', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '2px', padding: '0.25rem 0.6rem' }}>{f}</span>
                      ))}
                    </div>
                  </div>
                ))}
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.875rem', fontFamily: 'var(--font-b)', minWidth: '500px' }}>
                  <thead>
                    <tr style={{ background: '#00162e', color: 'rgba(255,255,255,0.6)', fontSize: '0.72rem', textTransform: 'uppercase', letterSpacing: '0.12em' }}>
                      <th style={{ padding: '1rem 1.25rem', textAlign: 'left' }}>Module</th>
                      <th style={{ padding: '1rem 1.25rem', textAlign: 'left' }}>Content Summary</th>
                    </tr>
                  </thead>
                  <tbody>
                    {CURRICULUM.map((row, i) => (
                      <tr key={i} style={{ borderTop: '1px solid rgba(255,255,255,0.04)', background: i % 2 === 0 ? 'rgba(255,255,255,0.01)' : 'transparent' }}>
                        <td style={{ padding: '1rem 1.25rem', color: '#FFFFFF', fontWeight: 600, whiteSpace: 'nowrap' }}>{row.module}</td>
                        <td style={{ padding: '1rem 1.25rem', color: 'rgba(255,255,255,0.65)' }}>{row.content}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: '2.5rem' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '1rem' }}>
                {[
                  ...
                  <div key={i} style={{ background: '#00162e', borderLeft: '3px solid #D8A027', padding: '1rem 1.25rem' }}>
                    <div style={{ fontSize: '0.68rem', color: '#D8A027', fontFamily: 'var(--font-h)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '0.4rem' }}>{e.label}</div>
                    <div style={{ fontSize: '0.85rem', color: '#FFFFFF', fontWeight: 600 }}>{e.value}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: '2.5rem' }}>
              ...
              <div style={{ border: '1px solid rgba(255,255,255,0.08)', borderRadius: '8px', overflow: 'hidden' }}>
                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.875rem', fontFamily: 'var(--font-b)' }}>
                  <thead>
                    <tr style={{ background: '#00162e', color: 'rgba(255,255,255,0.6)', fontSize: '0.72rem', textTransform: 'uppercase', letterSpacing: '0.12em' }}>
                      <th style={{ padding: '1rem 1.25rem', textAlign: 'left' }}>Career Option</th>
                      <th style={{ padding: '1rem 1.25rem', textAlign: 'left' }}>Sector</th>
                    </tr>
                  </thead>
                  <tbody>
                    {CAREER_OPTIONS.map((row, i) => (
                      <tr key={i} style={{ borderTop: '1px solid rgba(255,255,255,0.04)', background: i % 2 === 0 ? 'rgba(255,255,255,0.01)' : 'transparent' }}>
                        ...
                        <td style={{ padding: '1rem 1.25rem', color: 'rgba(255,255,255,0.65)' }}>{row.sector}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
          ...
          <div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
              <div style={{ background: '#000f1e', border: '1px solid rgba(255,255,255,0.08)', padding: '2rem', borderRadius: '1px', textAlign: 'center' }}>
                ...
                <span style={{ fontSize: '0.72rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.5)', display: 'block', marginBottom: '0.5rem' }}>Starting from</span>
                <div style={{ fontFamily: 'var(--font-h)', fontSize: '2.2rem', fontWeight: 900, color: '#D8A027' }}>₹5,000</div>
                <span style={{ fontSize: '0.62rem', color: 'rgba(255,255,255,0.3)', display: 'block', marginTop: '0.5rem' }}>P1 value ₹54,000 — free for Batch 1</span>
                ...
                <div style={{ fontFamily: 'var(--font-h)', fontSize: '1.3rem', fontWeight: 800, color: '#FFFFFF' }}>👥 Max 20 Students</div>
              </div>
