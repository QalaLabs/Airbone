    ...
    <>
      ...
      <main style={{ minHeight: '80vh', background: 'var(--paper)', padding: '4rem var(--margin) 6rem var(--margin)' }}>
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          {/* Table of Contents */}
          <nav aria-label="Table of contents" style={{ background: '#ffffff', border: '1px solid rgba(0,39,76,0.08)', padding: '1.5rem 1.75rem', borderRadius: '1px', marginBottom: '3rem' }}>
            <span style={{ fontSize: '0.68rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: 'rgba(33,33,33,0.55)', fontFamily: 'var(--font-h)', fontWeight: 700, display: 'block', marginBottom: '0.9rem' }}>On This Page</span>
                ...
                <tbody>
                  {COST_TABLE.map((row) => (
                    <tr key={row.component}>
                      ...
                      <td style={{ padding: '1rem 1.25rem', color: 'rgba(33,33,33,0.6)' }}>{row.note}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
                ...
                <tbody>
                  {INDIA_VS_ABROAD.map((row) => (
                    <tr key={row.factor}>
                      ...
                      <td style={{ padding: '1rem 1.25rem', color: 'rgba(33,33,33,0.75)' }}>{row.india}</td>
                      <td style={{ padding: '1rem 1.25rem', color: 'rgba(33,33,33,0.6)' }}>{row.abroad}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <section id="what-affects-cost" style={{ marginBottom: '3rem', scrollMarginTop: '6rem' }}>
            <h2 style={{ fontFamily: 'var(--font-h)', fontSize: '1.2rem', fontWeight: 800, color: 'var(--navy)', textTransform: 'uppercase', marginBottom: '1.25rem' }}>What Affects Your Total Cost</h2>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              {[
                ...
                <div key={i} style={{ borderLeft: '3px solid #DB241E', paddingLeft: '1.5rem' }}>
                  ...
                  <p style={{ fontSize: '0.85rem', color: 'rgba(33,33,33,0.7)', fontFamily: 'var(--font-b)', lineHeight: '1.6', margin: 0 }}>{s.detail}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          <div style={{ background: '#ffffff', border: '1px solid rgba(0,39,76,0.08)', padding: '1.75rem', borderRadius: '1px', marginBottom: '3rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '1.5rem', flexWrap: 'wrap' }}>
            <div>
              ...
              <p style={{ fontSize: '0.82rem', color: 'rgba(33,33,33,0.65)', fontFamily: 'var(--font-b)', margin: 0 }}>₹2,70,000 · Max 25 students per batch · Taught by Capt. Navrang Singh</p>
            </div>
          ...
          <div style={{ marginBottom: '3.5rem' }}>
            <div style={{ marginBottom: '2rem', textAlign: 'center' }}>
              <span style={{ fontSize: '0.65rem', letterSpacing: '0.25em', textTransform: 'uppercase', color: '#DB241E', fontWeight: 700, display: 'block', marginBottom: '0.75rem', fontFamily: 'var(--font-h)' }}>Admissions Open - Upcoming Batch</span>
