...
**Product category:** DGCA CPL ground school / pilot training institute / aviation academy

**Product type:** Education / coaching institute (offline-first, Dwarka Delhi campus)

**Business model:** Per-course fees. No subscriptions. Flagship: CPL Ground Classes at ₹2,70,000 for 4–6 months. Additional courses from ₹10,000/hr (A320 sim) to ₹25L+ (full PPL flying training).
...
**Target students:**
- Indian students aged 17–30 pursuing a DGCA Commercial Pilot Licence
- Career-changers (late 20s–mid 30s) restarting aviation ambitions
- Students who have recently passed Class 12 (Science stream, now also Arts/Commerce after 2026 DGCA rule change)
- Existing CPL holders or student pilots who failed DGCA exams and need re-coaching

**Target geographies (primary):** Delhi NCR, especially West Delhi. Secondary: pan-India (students relocate to Dwarka for the course).

**Decision-makers:** The student themselves + parents (especially for under-22 candidates). Parents are financial buyers; students are champions and users.

**Primary use case:** Pass all 5 DGCA CPL ground school papers on the first attempt, without rote learning.

**Jobs to be done:**
- "Prepare me to clear DGCA exams so I can get my CPL and apply for airline cadet programs."
- "Prepare me specifically for IndiGo / Air India / Akasa cadet selection tests."
- "Get me proficient on an Airbus A320 simulator before my airline type rating."
- "Help me restart my stalled pilot career."

**Use cases / scenarios:**
- Class 12 pass-out unsure which ground school to pick in Delhi
- Student pilot who failed DGCA exam once, needs serious second attempt
- Aspiring cadet needing CASS/COMPASS/ADAPT test prep
- Engineer or non-aviation professional switching to pilot career in mid-20s
...
- Retired instructors → outdated knowledge, no active airline context
- Rote-learning culture → students memorise answers but can't reason under exam pressure or in airline interviews
- No simulator access → no practical reinforcement of theory
- Competitors promise placement but have no named alumni proof

**What it costs students:**
- Time: Failed exams mean 6–12 months of delay minimum
- Money: Retake fees, extended stay costs, lost earning years
- Confidence: Failed exams are demoralising and affect flying performance
...
- "The batch size means he actually knows your name."
- "The A320 simulator made the theory click."
- "I saw the alumni list and called one of them before joining."
...
- Students looking for the cheapest possible option and willing to risk exam failure
- Students who need 100% online / remote learning (Airborne is in-person, Dwarka campus)
- Students already at flying school who only need a minimal theory refresher (they need a different product tier)
...
- Familiar with their current study materials and group
- Location inertia (don't want to move to Dwarka)

**Anxiety (worries about switching to Airborne):**
- "What if I pay and still fail?"
- "Is the batch full? When's the next batch?"
- "Will I fit in after already failing once?"
- "Is ₹2.7L worth it when other places charge less?"
...
**Words to use:**
- First attempt, DGCA exam, CPL, cadet program, concept-based, batch size, active captain, A320 simulator, Dwarka, airline selection, CASS/COMPASS/ADAPT, placement, results, alumni

**Words to avoid:**
- "World class" (cliché)
- "Best institute in India" (unverifiable)
- "Guaranteed job" (legally problematic)
- "Rote learning" in a positive context
- Generic "experienced faculty" (say "active airline captain" instead)
...
**Personality:** Trustworthy, serious, results-driven, quietly proud (not boastful). Like a mentor who's been there and knows the way.

**What it sounds like:**
- ✅ "Capt. Nipun Singh joined Air India at 36. He sat in that same classroom."
- ✅ "We cap every batch at 25. Not because we can't fit more. Because that's how teaching works."
- ❌ "Join the best aviation institute in India for your bright future!"
- ❌ "Our world-class faculty will guide you to success."
...
**Key metrics:**
- 15+ years mentoring pilots
- 2,100+ aspirants mentored
- 100% first-attempt DGCA pass rate
- Max 25 students per batch (enforced)
...
**Business goal:** Increase qualified leads (aspiring pilots or their parents) from Delhi NCR and pan-India who book a counselling call or visit the Dwarka campus.

**Conversion action:** Fill the lead form (homepage #cta, /contact, course sidebar) to book a free counselling session.

**Key acquisition channels (current):** Direct/referral (word of mouth is primary). SEO is underdeveloped. Social media presence unknown (pending audit).

**Current metrics:** Not formally tracked. Leads come through: phone calls to +91 9953-777-320, walk-ins to Ramphal Chowk campus, and website lead form.
